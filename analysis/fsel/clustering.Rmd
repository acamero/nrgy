...
par(mfrow=c(1,2))
barplot(freqs[16,], names.arg = list_hours,  xlab="Hour", ylab="Frequency", main="Centro de Salud")
barplot(freqs[9,], names.arg = list_hours,  xlab="Hour", ylab="Frequency", main="Museo")
```
